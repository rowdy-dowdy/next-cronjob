      ...
      <div className="w-full h-full flex flex-col space-y-6">
        ...
        <div className="flex-grow min-h-0 flex items-stretch space-x-3">
          <div className="w-1/3 bg-[--border] rounded-lg flex flex-col space-y-3">
            <div className="flex-none p-2 text text-center text-xl font-bold uppercase text-teal-300">
              Người chơi 1/ 4
            </div>
              ...
              <SimpleBarCustom options={{autoHide: false}} className="p-2 pr-4">
                <div className="flex flex-col space-y-2">
                  { new Array(100).fill(0).map((v,i) =>
                    <div key={i} className={`rounded-r-[30px] rounded-l-[100px] border-2 border-indigo-300/30 bg-indigo-600/30 p-1.5 flex space-x-4 items-center
                    ...
                    `}>
                      ...
                      <div className={`flex-grow min-w-0 font-bold text-lg uppercase text-indigo-300 ${i == 0 ? '!text-indigo-800' : ''}`}>Việt Hùng ít</div>
                      { i == 0
                        ? <span className="icon-svg w-7 h-7 p-1 rounded-full bg-indigo-600/80 text-gray-300">
          ...
          <div className="w-2/3 px-4 flex flex-col">
                  ...
                  ? <div className="w-full h-full grid gap-2 grid-cols-3">
                    { new Array(20).fill(0).map((v,i) =>
                      ...
                      `}>
                        ...
                        <span className="text-indigo-900 text-lg uppercase font-bold py-1">Thường</span>
                      </div>
                    )}
                  </div>
                  : <div>
                    <p className="font-bold text-xl text-center uppercase">CHỌN MỘT NHÂN VẬT VÀ Đăng nhập</p>
            ...
            <div className="flex-none p-4 flex justify-center space-x-4">
              <WebButton href="/lobby" icon={<span className="icon-svg w-6 h-6"><img src="/images/ic_copy.svg" /></span>}>Mời bạn</WebButton>
